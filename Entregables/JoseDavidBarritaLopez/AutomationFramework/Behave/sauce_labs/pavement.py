...
def run_feature(args):
    BehaveLocalRunner() \
        .with_local_testing_suite(args[0]) \
        .with_local_platform(args[1]) \
        .with_local_platform_version(args[2]) \
        .with_local_device_name(args[3]) \
        .with_local_environment(args[4]) \
        .with_local_program(args[5]) \
        .with_local_feature(args[6]) \
